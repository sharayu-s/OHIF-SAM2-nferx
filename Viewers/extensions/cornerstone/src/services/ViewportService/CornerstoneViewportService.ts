...
class CornerstoneViewportService extends PubSubService implements IViewportService {
  ...
  public async setVolumesForViewport(viewport, volumeInputArray, presentations) {
    ...
    //if (this.servicesManager.services.segmentationService.getActiveSegmentation()!=undefined){
    //  const currentSeg = this.servicesManager.services.segmentationService.getActiveSegmentation()
    //  this.servicesManager.services.segmentationService.jumpToSegmentCenter(currentSeg.id, 1, 'default')
    //}
