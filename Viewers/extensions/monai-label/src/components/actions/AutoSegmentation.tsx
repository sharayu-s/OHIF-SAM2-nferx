...
export default class AutoSegmentation extends BaseTab {
  ...
  onSegmentation = async () => {
    ...
    if (response.status !== 200) {
      ...
      let dicomDict = dcmjs.data.DicomMessage.readFile(response.data);
      ...
      let uploader = new DicomFileUploader(reportBlob, window.extensionManager.getActiveDataSource()[0])
      await uploader.load()
