...
class RectangleROITool extends AnnotationTool {
  ...
  _calculateCachedStats = (
    ...
    for (let i = 0; i < targetIds.length; i++) {
      ...
      pos1index[2] = services.measurementService.getMeasurements().filter((u) => {return u.uid === annotation.annotationUID})[0].displayText[1].split("I: ")[1].slice(0,-1)
      ...
      pos2index[2] = services.measurementService.getMeasurements().filter((u) => {return u.uid === annotation.annotationUID})[0].displayText[1].split("I: ")[1].slice(0,-1)
