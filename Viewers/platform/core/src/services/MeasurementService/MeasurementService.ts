  ...
  annotationToMeasurement(source, annotationType, sourceAnnotationDetail, isUpdate = false) {
    ...
    if (oldMeasurement) {
      ...
      if (isUpdate) {
        ...
        //if (annotationType == 'Probe' || annotationType=='Probe2'){
        //  extensionManager.modules.commandsModule.filter((e)=>{return e.extensionId=='@ohif/extension-default'})[0].module.actions.sam2_one()
        //}
      }
    } else {
